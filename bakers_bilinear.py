...
binary = config['bakers_bilinear_binary']
...
for i in range(6):
    ...
    p.stdin.write(array([0.2, 0.4, 0.0, 0.0], float32).tobytes())
...
fname = 'bilinear_{}_{}_{}_{}.npy'.format(os.path.basename(binary), myname, nIter, random.rand())
